...
# Fetch results.
$type_result = db_connect($db_service, $db_name, $db_user, $db_pass, $type_query);
# Draw drop-down list.
$selected = 0;
...
# Fetch results.
$sup_result = db_connect($db_service, $db_name, $db_user, $db_pass, $sup_query);
# Draw drop-down list.
...
if ($_POST[bev_name]<>"") {
	...
	$bev_table = "Beverages";
	$ins_query = "INSERT INTO $bev_table (Name, Type_ID, Alc, Vol, Price, Supplier_ID, Avail, House_Pouring) VALUES ('$bev_name', '$bev_type', '$alc' , '$bev_vol', '$bev_price', '$supplier', '$avail', '$house_pouring')";
